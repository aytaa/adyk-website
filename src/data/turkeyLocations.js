const turkeyLocations = {
  ...
  "Aydın": ["Bozdoğan","Efeler","Çine","Germencik","Karacasu","Koçarlı","Kuşadası","Kuyucak","Nazilli","Söke","Sultanhisar","Yenipazar","Buharkent","İncirliova","Karpuzlu","Köşk","Didim"],
  ...
  "Denizli": ["Acıpayam","Buldan","Çal","Çameli","Çardak","Çivril","Merkezefendi","Pamukkale","Güney","Kale","Sarayköy","Tavas","Babadağ","Bekilli","Honaz","Serinhisar","Baklan","Beyağaç","Bozkurt"],
  ...
  "Manisa": ["Akhisar","Alaşehir","Demirci","Gördes","Kırkağaç","Kula","Salihli","Sarıgöl","Saruhanlı","Selendi","Soma","Şehzadeler","Yunusemre","Turgutlu","Ahmetli","Gölmarmara","Köprübaşı"],
  ...
  "Mardin": ["Derik","Kızıltepe","Artuklu","Mazıdağı","Midyat","Nusaybin","Ömerli","Savur","Dargeçit","Yeşilli"],
...
export const getCities = () => Object.keys(turkeyLocations).sort((a, b) => a.localeCompare(b, 'tr'))

export const getDistricts = (city) => {
  const districts = turkeyLocations[city] || []
  return [...districts].sort((a, b) => a.localeCompare(b, 'tr'))
}

export default turkeyLocations
